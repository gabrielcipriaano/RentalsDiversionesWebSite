...
class Email
{
    ...
    public function sendResetInstructions()
    {
        ...
        $phpmailer->setFrom($_ENV['MAIL_USER'], "Rental's Y Diversiones");
        $phpmailer->addAddress($this->email, "Rental's Y Diversiones");

        $phpmailer->isHTML(true);
        $phpmailer->CharSet = 'UTF-8';
        $phpmailer->Subject = "Restablece tu password Rental's Y Diversiones";
        $confirmationLink = $_ENV['SERVER_HOST'] .'/reset?token=' . $this->token;
    ...
    public function sendContact()
    {
        ...
        $phpmailer->setFrom($_ENV['MAIL_USER'], "Rental's Y Diversiones");
        $phpmailer->addAddress('rentalsydiversiones@gmail.com', "Rental's Y Diversiones");
