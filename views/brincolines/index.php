<main class="contenedor">
    <a href="<?php echo !$find ? '/admin' : '/admin-brincolines'; ?>" class="admin-button w-10 m-t-5">
        Volver</a>
    <h1 class="admin__title"><?php echo !$find ? 'Brincolines' : 'Resultado de Búsqueda:'; ?></h1>
    <section class="search-and-add">
        <div class="search-bar">
            <form action="/admin-brincolines/find" method="post">
                    ...
                    <?php foreach ($brincolines as $brincolin) : ?>
                        <tr>
                            ...
                            <td class="actions">
                                ...
                                <form id="deleteBrincolinForm" action="/admin-brincolines/delete" method="post">
